...
<head>
    ...
    <link rel="shortcut icon" href="http://localhost/rightclick.com.ng/wp-content/themes/maheertheme/images/logo.png"> 
	...
	<link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.4.1/css/bootstrap.min.css" integrity="sha384-Vkoo8x4CGsO3+Hhxv8T/Q5PaXtkKtu6ug5TOeNV6gBiFeWPGFN9MuhOf23Q9Ifjh" crossorigin="anonymous">  
     // Theme CSS
	<link rel="stylesheet" href="http://localhost/rightclick.com.ng/wp-content/themes/maheertheme/css/style.css">
    -->
...
<header class="header text-center">	    
	    ...
	    <nav class="navbar navbar-expand-lg navbar-dark" >
			...
			?>
                ...
                <?php //this is navigation menus to be dynamic
                    wp_nav_menu ( array( 
                        'menu'          =>'primary',
                        'container'     => '',
